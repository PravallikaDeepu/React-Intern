...
function History() {
    return (
        <div>
            <img src="https://springdale.peelschools.org/images/b82d5de2-8621-4a01-9259-2a45f8789911" className='banner-img'/>

            <div className='home grid' >
                <div>

                    <img src={girlstudying} className='history-img' />
                </div>
                <div style={{marginTop: "40px", marginBottom: "40px"}}>
                    ...
                    Springdale Public School was established by the XYZ Foundation, a registered, not-for-profit organization that professionally manages the school. 
