    ...
    <div style={{ marginTop: "5px", height: "100px" }}>
      <div className='grid home'>
        <div style={{width: "500px"}}>
          ...
          <p style={{fontSize: "15px", margin: "30px 20px 0px 20px", textAlign: "justify", lineHeight:1}}>We are a part of XYZ Education Society, which has a strong presence on the education map of Pune. The Trust has been associated with Management education since 1994. The school segment has been operational since 2004.</p>
